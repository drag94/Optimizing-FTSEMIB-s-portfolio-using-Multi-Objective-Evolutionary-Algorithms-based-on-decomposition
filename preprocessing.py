...
listavuota = []
stock_names = []
path_stock_files = '/home/davide/PycharmProjects/pythonProject2/genetic_algo_progetto/po_moead/dati ftsemib listino'
...
del df_final['Data']
df_final.to_csv('genetic_algo_progetto/po_moead/dat/df_final1.txt',header=False,index=False)
...
df_ftsemib1.to_csv('/home/davide/PycharmProjects/pythonProject2/genetic algo progetto/po_moead/dat/df_ftsemib1.txt',
